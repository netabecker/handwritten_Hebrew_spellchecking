...
def segmentWordsInSentence(img):
    """
    Accepts an image of a sentence and segments words from it.
    It works by finding lengths of spaces, and clustering them to spaces between letters and spaces between words.
    :param img: Image of a sentence
    :return: A list of images of words
    """
    if len(img.shape) > 2:
